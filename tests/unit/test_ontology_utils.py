...
class TestOntologyUtils(unittest.TestCase):
    ...
    def test_get_category_terms(self):
        ...
        """
        category = {"description": "A location, relative to cellular compartments and structures, occupied by a macromolecular "
    ...
    def test_get_go_hierarchy_go_id(self):
        ...
        """
        for go_id in go_ids:
            response = test_client.get(f"/api/go/{go_id}/hierarchy")
