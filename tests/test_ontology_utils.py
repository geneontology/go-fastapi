...
def test_get_category_terms():
    category = {
            ...
            'groups': [{'id': 'GO:0005575', 'label': 'all cellular component',
                        'description': 'Show all cellular component annotations', 'type': 'All'}, {
                           ...
                           'id': 'GO:0005576', 'label': 'extracellular region', 'type': 'Term'}, {
                           ...
                           'id': 'GO:0005886', 'label': 'plasma membrane', 'type': 'Term'}, {
                           'description': 'The junction between an axon of one neuron and a dendrite of another '
                                          ...
                                          'membrane.',
                           'id': 'GO:0045202', 'label': 'synapse', 'type': 'Term'}, {
                           ...
                           'id': 'GO:0030054', 'label': 'cell junction', 'type': 'Term'},
                       {'description': 'A prolongation or process extending from a cell, e.g. a flagellum or axon.',
                        'id': 'GO:0042995', 'label': 'cell projection', 'type': 'Term'},
                       {'description': 'A vesicle found in the cytoplasm of a cell.', 'id': 'GO:0031410',
                        'label': 'cytoplasmic vesicle', 'type': 'Term'},
                       {'description': 'A vacuole to which materials ingested by endocytosis are delivered.',
                        'id': 'GO:0005768', 'label': 'endosome', 'type': 'Term'}, {
                           'description': 'A closed structure, found only in eukaryotic cells, that is completely '
                                          ...
                                          'cytosol.',
                           'id': 'GO:0005773', 'label': 'vacuole', 'type': 'Term'}, {
                           ...
                           'id': 'GO:0005794', 'label': 'Golgi apparatus', 'type': 'Term'}, {
                           'description': 'The irregular network of unit membranes, visible only by electron '
                                          ...
                                          'ribosomes attached).',
                           'id': 'GO:0005783', 'label': 'endoplasmic reticulum', 'type': 'Term'}, {
                           ...
                           'id': 'GO:0005829', 'label': 'cytosol', 'type': 'Term'}, {
                           ...
                           'id': 'GO:0005739', 'label': 'mitochondrion', 'type': 'Term'}, {
                           ...
                           'id': 'GO:0005856', 'label': 'cytoskeleton', 'type': 'Term'}, {
                           ...
                           'id': 'GO:0032991', 'label': 'protein-containing complex', 'type': 'Term'},
                       {'id': 'GO:0005575', 'label': 'other cellular component',
                        'description': 'Represent all annotations not mapped to a specific term', 'type': 'Other'}],
            'id': 'GO:0005575', 'label': 'cellular_component'}
