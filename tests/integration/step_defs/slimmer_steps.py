...
@given(parsers.cfparse('the "{endpoint:String} is queried with gene "{bioentity_id:String} and slim {slimterms:String}"',
...
@then(parsers.cfparse('the response should have an association with subject.label of {bioentity_label:String}',
...
@then(parsers.cfparse('the response contains an association with subject.id of {bioentity_id:String}',
                      extra_types=EXTRA_TYPES))
...
@then(parsers.cfparse('the response should have {term:String} in the slim',
                      extra_types=EXTRA_TYPES))
