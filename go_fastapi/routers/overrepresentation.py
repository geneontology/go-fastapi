...
from ontobio.golr.golr_associations import  GolrFields
...
parser.add_argument('subject_category', default='gene', help='Default: gene. Other types may be used but statistics '
                                                             'may not make sense')
parser.add_argument('max_p_value', default='0.05', help='Exclude results with p-value greater than this')
parser.add_argument('ontology', help='ontology id. Must be obo id. Examples: go, mp, hp, uberon (optional: will be '
                                     'inferred if left blank)')
parser.add_argument('taxon', help='must be NCBITaxon CURIE. Example: NCBITaxon:9606')


@api.doc(params={'object_category': 'CATEGORY of entity at link OBJECT (target), e.g. function'})
