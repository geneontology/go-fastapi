...
2) Precomputed GO-CAM index files: "https://current.geneontology.org/go-cams/index-json/"

Both sources are regenerated via the GO Pipeline and will return stable results for a given release.  
