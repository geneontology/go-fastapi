...
named_object = api.inherit('NamedObject', named_object_core, {
    ...
    'replaced_by': fields.List(
        fields.String(readOnly=True, description='Direct 1:1 replacement (if named object is obsoleted)')),
    'consider': fields.List(
        fields.String(readOnly=True, description='Potential replacement object (if named object is obsoleted)')),
})
...
bio_object = api.inherit('BioObject', named_object, {
    ...
    'xrefs': fields.List(fields.String,
...
disease_object = api.inherit('DiseaseObject', bio_object, {
    ...
    'clinical_modifiers': fields.List(fields.Nested(named_object_core),
                                      description='Clinical modifiers such as age of onset, pace of progression, and temporal patterns'),
})

# Assoc

annotation_extension = api.model('AnnotationExtension', {
    'relation_chain': fields.List(fields.Nested(relation),
                                  description='Relationship type. If more than one value, interpreted as chain'),
    'filler': fields.Nested(named_object,
...
chained_association = api.model('ChainedAssociation', {
    'proximal_association': fields.Nested(association,
                                          description='immediate association, between subject and intermediate object'),
    'distal_associations': fields.List(fields.Nested(association),
                                       description='Associations where the intermediate object is the subject')
})

slimmed_association = api.model('SlimmedAssociation', {
    'associations': fields.List(
        fields.Nested(association, description='immediate association, between subject and intermediate object')),
...
gene_product = api.inherit('GeneProduct', bio_object, {
    'sequence_features': fields.List(fields.Nested(sequence_feature),
                                     description='Sequence feature representing this particular instance on a genome'),
    'genes': fields.List(fields.Nested(entity_reference),
                         description='References to any gene objects that have this as product')
})
...
exon = api.inherit('Exon', bio_object, {
    'sequence_features': fields.List(fields.Nested(sequence_feature),
                                     description='Sequence feature representing this particular instance on a genome'),
    'genes': fields.List(fields.Nested(entity_reference),
                         description='References to any gene objects that have this exon in any of their transcripts')
})
...
regulatory_element = api.inherit('RegulatoryElement', bio_object, {
    'sequence_features': fields.List(fields.Nested(sequence_feature),
                                     description='Sequence feature representing this particular instance on a genome'),
    'targets': fields.List(fields.Nested(entity_reference),
                           description='References to any gene objects whose expression is regulated by this element')
})
...
transcript = api.inherit('Transcript', bio_object, {
    ...
    'genes': fields.List(fields.Nested(entity_reference),
                         description='References to any gene objects that have this transcript. This may not be populated if this is contained in a gene object'),
})
...
gene = api.inherit('Gene', bio_object, {
    ...
    'chromosome': fields.Nested(chromosome,
                                description='chromosome on which this gene is located. This may be redundant with information in sequence_feature objects but is included here for convenience'),
    'sequence_features': fields.List(fields.Nested(sequence_feature),
                                     description='Sequence feature representing particular instance on a genome'),
    'transcripts': fields.List(fields.Nested(transcript), description='All transcripts belonging to this gene'),
    'families': fields.List(fields.Nested(named_object),
                            description='Families, superfamilies etc to which these gene belongs'),
    'phenotype_associations': fields.List(fields.Nested(association),
                                          description='phenotypes associated with alterations of gene'),
    'disease_associations': fields.List(fields.Nested(association),
                                        description='diseases associated with alterations of gene'),
    'homology_associations': fields.List(fields.Nested(association),
                                         description='orthology and paralogy assocations for this gene'),
    'function_associations': fields.List(fields.Nested(association), description='GO assocations for wild type gene'),
    'pathway_associations': fields.List(fields.Nested(association),
                                        description='Assocations to pathways in which this gene is involved, including LEGO models'),
    'genotype_associations': fields.List(fields.Nested(association),
                                         description='associations to genotypes in which this gene is altered'),
    'interaction_associations': fields.List(fields.Nested(association),
                                            description='associations to genes that interact (may be physical or genetic)'),
