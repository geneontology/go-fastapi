...
async def get_term_metadata_by_id(
    id: str = Path(
        ..., description="The ID of the term to extract the metadata from, e.g. GO:0003677", examples="GO:0003677"
    ),
):
...
async def get_term_graph_by_id(
    id: str = Path(
        ..., description="The ID of the term to extract the graph from,  e.g. GO:0003677", examples="GO:0003677"
    ),
...
async def get_subgraph_by_term_id(
    id: str = Path(
        ..., description="The ID of the term to extract the subgraph from,  e.g. GO:0003677", examples="GO:0003677"
    ),
...
async def get_ancestors_shared_by_two_terms(
    subject: str = Path(..., description="Identifier of a GO term, e.g. GO:0006259", examples="GO:0006259"),
    object: str = Path(..., description="Identifier of a GO term, e.g. GO:0016070", examples="GO:0016070"),
):
    """
...
async def get_ancestors_shared_between_two_terms(
    subject: str = Path(..., description="Identifier of a GO term, e.g. GO:0006259", examples="GO:0006259"),
    object: str = Path(..., description="Identifier of a GO term, e.g. GO:0016070", examples="GO:0016070"),
    relation: str = Query(None, description="relation between two terms", examples="closest"),
):
    """
    Returns the ancestor ontology terms shared by two ontology terms.
...
async def get_go_hierarchy_go_id(
    id: str = Path(..., description="A GO-Term ID, e.g. GO:0097136", examples="GO:0008150")
):
    """
...
async def get_gocam_models_by_go_id(
    id: str = Path(..., description="A GO-Term ID(e.g. GO:0008150 ...)", examples="GO:0008150")
):
    """
